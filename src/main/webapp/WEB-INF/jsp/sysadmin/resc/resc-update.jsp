...
<div class="pd-20">
  <form action="${pageContext.request.contextPath}/resc/async/update" method="post" class="form form-horizontal" 
  id="form-salesMan-add" >
  	<!-- 隐藏域，ID -->
  	<input type="text" name="resc_id" value="${resc.resc_id}" style="display:none">
  	
  	<!-- 权限名称 -->
    <div class="row cl">
      <label class="form-label col-3">权限名称:</label>
      <div class="formControls col-5">
        <input type="text" class="input-text" value="${resc.resc_name}"  autocomplete="off"
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="${resc.res_type}"  autocomplete="off"
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="${resc.res_string}"  autocomplete="off"
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="number" class="input-text" value="${resc.priority}"  autocomplete="off"
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="${resc.descn}"  autocomplete="off"
